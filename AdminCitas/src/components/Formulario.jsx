    ...
    return(
        <div className="w-1/3 mb-10">
            ...
            <form  className="bg-white px-5 py-8 rounded-lg shadow-xl">
                ...
                <div className="">
                    <button  className="hover:bg-indigo-700 w-full block bg-indigo-600 py-3 text-white uppercase font-bold rounded-lg">{paciente._id ? "Actualizar Paciente" : "Agregar Paciente"}</button>
                </div>
            </form>
        </div>
    );
